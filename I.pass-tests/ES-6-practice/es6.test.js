const { arrow, defaultParameter, combineArrays, destructuring, templateString } = require("./es6.js");
...
describe(`Given the arrow, defaultParameter, combineArrays, destructuring, templateString functions`, () => {
